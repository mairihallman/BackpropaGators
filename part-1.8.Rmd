...
```
```{python}
model = my_model_mbgd(shape=(28,28),n=300,classes=10,learning_rate=0.01,x_train=x_train_nv,y_train =y_train_nv,epochs=25,batch_size=50,x_val=x_val,y_val=y_val)
```
```{python}
